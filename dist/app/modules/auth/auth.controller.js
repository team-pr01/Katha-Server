...
const signup = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    (0, sendResponse_1.default)(res, {
        ...
        success: true,
        message: "Registration completed successfully. Welcome to Katha Celebrations!",
        data: result,
    });
}));
// User Login
...
const resendForgotPasswordOtp = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const { email } = req.body;
    yield auth_service_1.AuthServices.resendForgotPasswordOtp(email);
    (0, sendResponse_1.default)(res, {
        statusCode: http_status_1.default.OK,
        success: true,
