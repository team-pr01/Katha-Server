...
import { TPersonalizedOrder } from "./personalizedOrders.interface";

const personalizedOrderSchema = new Schema<TPersonalizedOrder>(
    {
        occasion: {
            type: String,
            required: true,
...
const PersonalizedOrder = model<TPersonalizedOrder>(
    "PersonalizedOrder",
    personalizedOrderSchema
);
